...
class OverviewTrigger extends StatelessWidget{
  ...
  Widget build(BuildContext context) {
    return Container(child: TriggerOverviewWidget(context: context, trigger: trigger), alignment: Alignment.center,);
  }

  //The trigger itself.

  Widget TriggerOverviewWidget({required BuildContext context, required Trigger trigger}){
